...
def moderator_required(func):
    ...
    async def wrapper(*args, **kwargs):
        # Find the discord.Interaction object from the arguments passed to the command.
        # This makes the decorator versatile for use in cogs (self, interaction, ...)
        # or standalone commands (interaction, ...).
