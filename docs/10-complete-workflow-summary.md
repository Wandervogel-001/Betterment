...
### 1. Database Architecture ([03-database-architecture.md](03-database-architecture.md))
...
### 2. Teams Cog Architecture ([04-teams-cog-overview.md](04-teams-cog-overview.md))
...
### 3. Command System ([05-slash-commands-workflow.md](05-slash-commands-workflow.md))
...
### 4. UI Component System ([06-ui-components-workflow.md](06-ui-components-workflow.md))
...
### 5. Button Workflow System ([07-button-workflows-detailed.md](07-button-workflows-detailed.md))
...
### 6. AI Profile Processing ([08-ai-profile-processing.md](08-ai-profile-processing.md))
...
### 7. Team Formation Algorithm ([09-team-formation-algorithm.md](09-team-formation-algorithm.md))
...
- **[Database Architecture](03-database-architecture.md)**: MongoDB schema and data management
- **[Teams Cog Overview](04-teams-cog-overview.md)**: Core application architecture
- **[Slash Commands Workflow](05-slash-commands-workflow.md)**: Command system implementation
- **[UI Components Workflow](06-ui-components-workflow.md)**: Interactive interface design
- **[Button Workflows Detailed](07-button-workflows-detailed.md)**: User action handling
- **[AI Profile Processing](08-ai-profile-processing.md)**: Intelligent data extraction
- **[Team Formation Algorithm](09-team-formation-algorithm.md)**: Clustering and optimization
